...
const AvatarCard = ({ avatar = '/tm1.jpg', title = "The Man", description = "A brief description about the man.", subTitle = 'Developer' }) => {
  return (
    <CardSpotlight>
      <div className="relative h-full p-6 flex flex-col">

        {/* Name */}
        <img src={avatar} alt="" className="rounded-full w-20 h-20 mb-2" />
        ...
        {/* Name */}
        <h3 className="clash-display text-xl mb-2">{subTitle}</h3>
