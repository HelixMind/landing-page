  ...
  return (
    <section className="container mx-auto px-4 py-20 relative bg-black">
      ...
      <div className="bg-[#0a0a0a]/80 backdrop-blur-lg border border-white/10 rounded-2xl p-8 md:p-12 text-center relative z-10">
        ...
        <button className="centered-row mx-auto text-[0.9rem] lg:text-lg bg-gradient-to-r from-indigo-400 to-indigo-600 clash-display hover:-translate-y-1 transition2 text-zinc-50 py-3 rounded-full px-3 cursor-pointer">
